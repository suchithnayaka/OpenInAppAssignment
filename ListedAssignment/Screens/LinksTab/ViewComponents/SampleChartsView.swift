...
struct SampleLineChartView: View {
    let sampleClicksData = [ ClicksData(month: 1, day: 1, clicks: 0.0),
                              ClicksData(month: 2, day: 1, clicks: 17.0),
                              ClicksData(month: 3, day: 1, clicks: 5.0),
                              ClicksData(month: 4, day: 1, clicks: 11.0),
                              ClicksData(month: 5, day: 1, clicks: 8.0),
                              ClicksData(month: 6, day: 1, clicks: 25.0),
                              ClicksData(month: 7, day: 1, clicks: 30.0),
                              ClicksData(month: 8, day: 1, clicks: 19.0),
                              ClicksData(month: 9, day: 1, clicks: 9.0)
    ]
